   ...
   return (
      <>
            ...
            <div className="course-section">
               <Accordion defaultActiveKey="0" flush>
                  ...
                  {completedModule.length === courseContent.length && (
                     <Button className='my-2' onClick={() => setShowModal(true)}>Get Your Certificate</Button>
                  )}
               </Accordion>
            </div>
         ...
         >
            ...
            <Modal.Body>
               <div className="mb-3">
                  <strong>Congratulations!</strong> You have successfully completed all sections of this course. Celebrate your achievement with your personalized certificate below.
               </div>
               ...
               <Button onClick={() => downloadPdfDocument('certificate-download')} style={{ float: 'right', marginTop: 3 }}>Download Your Certificate</Button>
            </Modal.Body>
         </Modal>
      </>
   );
